      ...
      <footer>
          ...
          <div className="footer-content">
              ...
              <div className="footer-logo">
                ...
                <div className="logo-text">
                  ...
                  <div className="logo-text-subtitle">
                    кафедри комп’ютерних наук КПНУ ім. Івана Огієнка
                  </div>
                </div>
              </div>
              <div className="social-media">
                <a
                  href="https://www.instagram.com/cs_kpnu"
                  target="_blank"
                  className="instagram"
                >
                ...
                <a
                  href="https://www.tiktok.com/@cs_kpnu"
                  target="_blank"
                  className="tiktok"
                >
                ...
                <a
                  href="https://www.facebook.com/cs.kpnu"
                  target="_blank"
                  className="facebook"
                >
                ...
                <a
                  href="https://ua.linkedin.com/company/cs-kpnu"
                  target="_blank"
                  className="linkedin"
                >
            ...
            <div className="footer-content-column">
              <div className="footer-useful-links">
                <div className="footer-useful-links-title">
                  Корисні посилання
                </div>
            ...
            <div className="footer-content-column">
              ...
              <a
                ...
                href="https://maps.app.goo.gl/D1QAXSy6cu2XuP7g9"
                target="_blank"
              >
                ...
                <div className="contact-item-text">
                  32301, Україна, Хмельницька область, м. Кам’янець-Подільський,
                  вул. Симона Петлюри, 1, пов. 4, каб. 44
                </div>
              </a>
              <a
                className="contact-item"
                href="mailto:digitaldepartment@kpnu.edu.ua"
              >
        ...
        <div className="copyright">
          <div className="copyright-text">
            © 2026 Кафедра комп'ютерних наук. Усі права захищені.
          </div>
        </div>
      </footer>
    </div>
