  ...
  },
{
  ...
  participants: [
    ...
    description:
      `це автономний програмно-аналітичний комплекс, що приймає великі масиви неструктурованих текстових даних (відгуки, результати опитувань, тікети) та автоматично генерує стратегічні звіти за допомогою великих мовних моделей (LLM). Проєкт ефективно усуває проблему ручної праці, перетворюючи «текстовий хаос» на готові аналітичні інсайти менш ніж за 60 секунд. Практична апробація системи та її робота в інфраструктурі університету доступні за посиланням: analytics.cs.kpnu.edu.ua.`,
    technologies:
...
},
{
  ...
  launchDate: "Жовтень 2025",
  description: "це гейміфікований симулятор для вивчення математики, який адаптується до рівня учня. Завдяки ігровим механікам та алгоритмам адаптивного навчання платформа робить навчання інтерактивним, підтримує мотивацію та допомагає ефективно засвоювати матеріал.",
