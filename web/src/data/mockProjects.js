...
export const mockProjects = [
  ...
  // },
  {
    ...
    launchDate: "Вересень 2025",
    description:
      `Веб-додаток для автоматизації процесу збору, аналізу та візуалізації даних соціологічних опитувань. Головна мета — надати зручний інструмент для моніторингу потреб молоді, використовуючи сучасні технології, включно з аналізом за допомогою штучного інтелекту.
    Ключові можливості: гнучкий конструктор опитувань, аналіз текстових відповідей, візуалізація кількісних даних у вигляді графіків та діаграм, можливість експорту результатів аналізу у форматі PDF, розмежування прав доступу.`,
    technologies:
      "Система побудована на основі клієнт-серверної архітектури з використанням Python, React, MongoDB (з використанням pymongo), Pandas, Matplotlib, google-genai.",
    participants: [
      {
        name: "Іванюк Віталій",
        role: "Mentor",
